...
public class Calculator
{
    ...
    protected static int calculateTwoTokens(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        // TODO: complete this...
        	// makes sure that that input string is either "halve" or "negate"
    ...
    {
        // TODO: complete this...
    	// NumberFormatException will be thrown automatically if input is not a integer 
    ...
    public static String parseAndExecute(String input)
    {
    	...
    	catch (CalculatorException excpt)
    	{
